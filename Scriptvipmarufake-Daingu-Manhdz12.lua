...
shared.LoaderTitle = "Đại ngu như dog";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://126677833379688",
...
local v15 = v14:CreateWindow({
    Title = "MacuVN Hub | Premium script| Fake Maru",
    SubTitle = "Dai ngu nhu dog | Manh7B5",
    TabWidth = 160,
    Theme = "White",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=126677833379688";
v24.Parent = v23;
